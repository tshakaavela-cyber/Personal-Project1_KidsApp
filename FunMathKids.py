...
#         self.root.title("FunMath Kids SA")
#         self.root.geometry("600x500")
#         self.root.configure(bg="#E0F7FA")  # Kid-friendly light blue background
...
#         # 3. LOAD IMAGES SAFELY (App won't crash if files are missing)
#         self.star_img = self.load_image("images/star.png")   
#         self.happy_img = self.load_image("images/happy.png") 
#         self.sad_img = self.load_image("images/sad.png")     

#         # 4. SHOW THE WELCOME SCREEN FIRST
#         self.show_welcome_screen()
...
#     def speak(self, text):
#         """Uses Linux's built-in tool to speak safely without crashing Python."""
#         # 'os.system' sends a message to your Linux operating system to say the words out loud.
#         # Adding ' &' at the end tells Linux to speak in the background so the game window doesn't freeze!
